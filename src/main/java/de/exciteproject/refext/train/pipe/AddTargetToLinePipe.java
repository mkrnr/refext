...
/**
 * Adds a O-tag in front of a given layout line if length==minLineLength. This
 * is needed for files that generated with {@link CermineLineLayoutExtractor}.
 * This is needed since the mallet CRF expects a target variable, even for
